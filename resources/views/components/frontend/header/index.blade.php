<header class="header-area">
    <div class="top-header">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <!-- Breaking News Area -->
                <x-frontend.header.breaking-news-area :breakingNews="$breakingNews"></x-frontend.header.breaking-news-area>
                <!-- Stock News Area -->
            ...
            <div class="row h-100 align-items-center">
                ...
                <div class="col-12 col-md-8">
                    <div class="header-advert-area">
                        <a href="#"><img src="{{asset('assets/frontend/img/core-img/advert.png')}}" alt="header-add"></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Bottom Header Area -->
    <x-frontend.header.navigation></x-frontend.header.navigation>
</header>
